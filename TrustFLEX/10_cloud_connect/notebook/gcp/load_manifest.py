...
home_path = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.realpath(__file__))))))
...
def gcp_upload_manifest(credential_file,signer_cert,mchp_manifest):
    ...
    return load_manifest(project, registry_id, region_id, manifest)