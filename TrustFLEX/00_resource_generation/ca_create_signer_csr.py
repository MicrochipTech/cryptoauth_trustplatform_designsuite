...
def ca_create_signer_csr(signer_ca_key_path=SIGNER_CA_KEY_FILENAME, signer_ca_csr_path=SIGNER_CA_CSR_FILENAME, signer_csr_org_name=u'Microchip Technology Inc'):
    # Load or create a signer CA key pair
    print('\nLoading signer CA key')
    signer_ca_priv_key = load_or_create_key(signer_ca_key_path, verbose=False)
    ...
    builder = builder.subject_name(x509.Name([
        x509.NameAttribute(x509.oid.NameOID.ORGANIZATION_NAME, signer_csr_org_name),
