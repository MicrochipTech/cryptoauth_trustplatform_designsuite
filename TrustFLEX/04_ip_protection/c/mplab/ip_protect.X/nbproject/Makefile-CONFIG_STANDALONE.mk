...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-CONFIG_STANDALONE.mk dist/${CND_CONF}/${IMAGE_TYPE}/ip_protect.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/43898991/ip_protect.o: ../../ip_protect.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/_ext/43898991/ip_protect.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG   -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -ffunction-sections -fdata-sections -O1 -DATCA_HAL_I2C -I"packs/ATSAMD21J18A_DFP" -I"packs/CMSIS/CMSIS/Core/Include" -I"packs/CMSIS" -I"config/default" -I"../../../../../assets/dependencies/common" -I"../../../../../assets/dependencies/cryptoauthlib/lib" -Wall -MMD -MF "${OBJECTDIR}/_ext/43898991/ip_protect.o.d" -o ${OBJECTDIR}/_ext/43898991/ip_protect.o ../../ip_protect.c    -DXPRJ_CONFIG_STANDALONE=$(CND_CONF)    $(COMPARISON_BUILD)  
