...
#endif
#include "../../00_resource_generation/secureboot_test_app.h"
#include "../../00_resource_generation/secureboot_test_app_sign.h"
#include "../../00_resource_generation/slot_6_secret_key.h"
...
*/
      ...
      {
		  if(ATCA_SUCCESS != (status = atcab_secureboot_mac(SECUREBOOT_MODE_FULL_COPY, app_digest, app_signature, host_random, io_protection_key, &is_verified)))
		  break;
		  if(is_verified)
		  {
			  printf("Firmware validation is successful.\r\n");
