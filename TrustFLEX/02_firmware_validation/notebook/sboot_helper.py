...
def program_public_key(b):
    # loading keyfile and programming public key into ECC608B device.,
    ...
    cfg.devtype = common_helper.get_device_type_id('ATECC608')
    ...
    dev_type = common_helper.get_device_type_id(get_device_name(info))
...
def combine_sign_hex(boot_data, app_data):
    ...
    print(str(common_helper.convert_to_hex_bytes(calc_sign)))
